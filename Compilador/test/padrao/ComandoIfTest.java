...
public class ComandoIfTest {
    ...
    */
    ...
    public void testExecuta() {
        ...
        ComandoIf instance = new ComandoIf("true", cmdif, false, cmdif);
        ComandoIf instance2 = new ComandoIf("false", cmdif, true, cmdelse);
        ComandoIf instance3 = new ComandoIf("false", cmdif, false, cmdelse);
